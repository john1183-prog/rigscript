    ...
    companion object {
        ...
        val DEMO = AnimScript(
            events = listOf(
                ...
                ScriptEvent(6.0f,  "think",          0.8f, "ease_in_out"),
                ScriptEvent(8.5f,  "excited",        0.5f, "elastic_out"),
                ScriptEvent(11.0f, "walk_a",         0.4f, "ease_in_out"),
                ScriptEvent(11.8f, "walk_b",         0.4f, "ease_in_out"),
                ScriptEvent(12.6f, "walk_a",         0.4f, "ease_in_out"),
                ScriptEvent(13.4f, "stand_straight", 0.5f, "ease_out"),
                ScriptEvent(15.0f, "celebrate",      0.6f, "elastic_out"),
                ScriptEvent(17.5f, "stand_straight", 0.8f, "ease_in_out")
            )
        )
    }
}
